    ...
    return [
      {
        ...
        subtitle: 'Радий представити своє портфоліо! Відкрийте двері до креативного світу, де зустрічаються дизайн і технології .',
      ...
      },
      {
        ...
        subtitle: `Привіт! Я фронтенд розробник з великою пристрастю до створення вебінтерфейсів. Займаюся перетворенням дизайну в реальність, надаючи користувачам візуально привабливі та функціональні веб-додатки`,
      },
      {
        cameraRailDist: -1,
        position: new Vector3(
